...
df_hosa=spark.read.parquet("abfss://bronze@rcmstorageadls.dfs.core.windows.net/hosa/transactions")

#Reading Hospital B departments data 
df_hosb=spark.read.parquet("abfss://bronze@rcmstorageadls.dfs.core.windows.net/hosb/transactions")
