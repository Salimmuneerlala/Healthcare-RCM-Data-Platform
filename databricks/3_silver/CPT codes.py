...
# Read the CSV file
cptcodes_df = spark.read.csv("abfss://landing@rcmstorageadls.dfs.core.windows.net/cptcodes/*.csv", header=True)
...
cptcodes_df.write.format("parquet").mode("overwrite").save("abfss://bronze@rcmstorageadls.dfs.core.windows.net/cpt_codes")
