...
claims_df=spark.read.csv("abfss://landing@rcmstorageadls.dfs.core.windows.net/claims/*.csv",header=True)
...
claims_df.write.format("parquet").mode("overwrite").save("abfss://bronze@rcmstorageadls.dfs.core.windows.net/claims/")
